...
public class FontUtils {
    ...
    public static void drawString(DrawContext graphics, String text, int x, int y, int color, boolean dropShadow) {
        graphics.text(Minecraft.getInstance().font, get(text), x, y, color, dropShadow);
    }

    public static void drawCenteredString(DrawContext graphics, String text, int x, int y, int color) {
        graphics.centeredText(Minecraft.getInstance().font, get(text), x, y, color);
    }
    
    public static void drawRightAlignedString(DrawContext graphics, String text, int rightX, int y, int color) {
