...
public class KeybindWater extends Module {
    ...
    public KeybindWater() {
        super("KeybindWater", Category.UHC, "Silently places or picks up water with a water/empty bucket.");
    }
    ...
    public void onTick() {
        ...
        if (step == 0) {
            int targetSlot = ModuleUtils.findItemInHotbar(Items.WATER_BUCKET);
            if (targetSlot == -1) {
