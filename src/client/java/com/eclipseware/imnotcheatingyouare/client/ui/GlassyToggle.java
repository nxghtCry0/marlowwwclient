...
public final class GlassyToggle extends CompatAbstractWidget {
    ...
    protected void renderWidget(DrawContext DrawContext, int mouseX, int mouseY, float partialTick) {
        ...
        DrawContext.fill(x, y, x + w, y + h, track);
        ...
        DrawContext.fill(knobX, knobY, knobX + knobSize, knobY + knobSize, knob);
        DrawContext.renderOutline(knobX, knobY, knobSize, knobSize, 0x60FFFFFF);
    }
