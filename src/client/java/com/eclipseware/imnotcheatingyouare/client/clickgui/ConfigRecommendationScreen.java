...
public class ConfigRecommendationScreen extends Screen {
    ...
    @Override
    public void extractBackground(DrawContext DrawContext, int mouseX, int mouseY, float partialTick) {
        super.extractBackground(DrawContext, mouseX, mouseY, partialTick);
        DrawContext.fill(0, 0, this.width, this.height, new Color(15, 15, 40, 200).getRGB());
    }
